...
VITE_API_BASE_URL=https://16d791950278.ngrok-free.app/api
```
...
1. Set the **App URL** to: `https://16d791950278.ngrok-free.app`
2. Set the **Allowed redirection URL(s)** to: `https://16d791950278.ngrok-free.app/auth/callback`
